...
install_command="curl -fsSL https://raw.githubusercontent.com/LineZero-Studio/openclaw-diy/v0.1.2/install.sh | bash"
skip_model_command="curl -fsSL https://raw.githubusercontent.com/LineZero-Studio/openclaw-diy/v0.1.2/install.sh | bash -s -- --skip-model"
telegram_command="curl -fsSL https://raw.githubusercontent.com/LineZero-Studio/openclaw-diy/v0.1.2/scripts/add-telegram.sh | bash"
...
assert_contains "site-config.js" "releaseTag = \"v0.1.2\""
assert_contains "install.sh" "RELEASE_TAG=\"v0.1.2\""
