...
```bash
git status --short
git tag -a v0.1.1 -m "OpenClaw DIY v0.1.1"
...
```bash
curl -fsSL https://raw.githubusercontent.com/LineZero-Studio/openclaw-diy/v0.1.1/install.sh | bash -n
curl -fsSL https://raw.githubusercontent.com/LineZero-Studio/openclaw-diy/v0.1.1/scripts/add-telegram.sh | bash -n
```
